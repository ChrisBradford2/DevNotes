...
Pour signaler un bug, [ouvrez un nouveau ticket](https://github.com/ChrisBradford2/DevNotes/issues/new), et assurez-vous d'inclure autant de détails que possible, en utilisant la template.
...
Si vous voulez aussi corriger le bug, soumettez un [pull request](#pull-requests) et référencez le ticket.
...
Pour suggérer une nouvelle fonctionnalité/un nouveau sujet, [ouvrir un nouveau ticket](https://github.com/ChrisBradford2/DevNotes/issues/new), en utilisant la suggestion template.
